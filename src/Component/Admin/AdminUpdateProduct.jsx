                        ...
                        <form className='p-3' onSubmit={postData}>
                            ...
                            <div className='row mb-3'>
                                <div className='col-md-6 col-12'>
                                    ...
                                    <input type='text' name='color' id='color' placeholder='Enter Color' onChange={getData} className='form-control' value={data.color}></input>
                                </div>
                                <div className='col-md-6 col-12'>
                                    <label htmlFor='size'>Size</label>
                                    <input type='text' name='size' id='size' placeholder='Enter Size' onChange={getData} className='form-control' value={data.size}></input>
                                </div>
                            </div>
                            <div className='row mb-3'>
                                <div className='col-md-6 col-12'>
                                    <label htmlFor='Baseprice'>Base Price</label>
                                    <input type='number' name='baseprice' id='baseprice' placeholder='Enter Base Price' onChange={getData} className='form-control' value={data.baseprice}></input>
                                </div>
                                <div className='col-md-6 col-12'>
                                    <label htmlFor='discount'>Discount</label>
                                    <input type='number' name='discount' id='discount' placeholder='Enter Discount' onChange={getData} className='form-control' value={data.discount}></input>
                                </div>
                            </div>
                            <div className='mb-3'>
